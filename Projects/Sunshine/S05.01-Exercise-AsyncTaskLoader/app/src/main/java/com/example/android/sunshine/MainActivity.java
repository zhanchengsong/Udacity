...
public class MainActivity extends AppCompatActivity implements ForecastAdapterOnClickHandler, LoaderManager.LoaderCallbacks<String[]> {
    ...
    private void loadWeatherData() {
        ...
        Bundle weather_parameter_bundle = new Bundle();
        weather_parameter_bundle.putString(WEATHER_LOCATION_KEY, location);

        LoaderManager loaderManager = getLoaderManager();
        if (loaderManager.getLoader(WEATHER_LOADER_ID) == null) {
            loaderManager.initLoader(WEATHER_LOADER_ID, weather_parameter_bundle, this);
        } else {
            loaderManager.restartLoader(WEATHER_LOADER_ID,weather_parameter_bundle,this);
        }
    ...
    public Loader<String[]> onCreateLoader(int i, final Bundle bundle) {
        return new AsyncTaskLoader<String[]>(this) {
            ...
            protected void onStartLoading() {
                if (bundle==null) {
                    return; // Stop loading as if the arguments did not pass anything
                }
            ...
            public String[] loadInBackground() {
                String location = bundle.getString(WEATHER_LOCATION_KEY);
